...
val return :
  proof -> Term.constr -> Term.constr * Declarations.side_effects
...
val set_proof_info : Store.t -> proof -> proof

(*** Tactics ***)

val run_tactic : Environ.env -> unit Proofview.tactic -> proof -> proof

val emit_side_effects : Declarations.side_effects -> proof -> proof
