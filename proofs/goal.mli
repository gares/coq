...
val eval :
  'a sensitive -> Environ.env -> Evd.evar_map -> goal ->
    'a * Evd.evar_map * Declarations.side_effects
...
val return : 'a -> Declarations.side_effects -> 'a sensitive
...
val list_map : 
  (Evd.evar_map -> 'a -> 'b * Evd.evar_map * Declarations.side_effects) ->
  'a list -> Evd.evar_map ->
    'b list * Evd.evar_map * Declarations.side_effects list
