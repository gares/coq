...
val sig_it  : 'a sigma   -> 'a * Declarations.side_effects
val project : goal sigma -> evar_map

val re_sig : 'a * Declarations.side_effects -> evar_map -> 'a sigma

val unpackage : 'a sigma -> evar_map ref * 'a * Declarations.side_effects ref
val repackage : Declarations.side_effects ref -> evar_map ref -> 'a -> 'a sigma
val apply_sig_tac :
  Declarations.side_effects ref -> evar_map ref -> 
