...
type mutual_scheme_object_function =
  mutual_inductive -> constr array * Declarations.side_effects
type individual_scheme_object_function =
  inductive -> constr * Declarations.side_effects
...
val define_individual_scheme : individual scheme_kind -> 
  ...
  identifier option -> inductive -> constant * Declarations.side_effects

val define_mutual_scheme : mutual scheme_kind -> Declare.internal_flag (** internal *) ->
  (int * identifier) list -> mutual_inductive -> constant array * Declarations.side_effects

(** Main function to retrieve a scheme in the cache or to generate it *)
val find_scheme : 'a scheme_kind -> inductive -> constant * Declarations.side_effects
