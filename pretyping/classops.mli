...
val find_class_type : evar_map -> types -> cl_typ * Sorts.sort_instance * constr list
...
val coercion_value : coe_index -> (unsafe_judgment * bool * bool) Sorts.in_universe_context_set
