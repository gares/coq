...
let sym_scheme_kind =
  ...
  (fun ind -> build_sym_scheme (Global.env() (* side-effect! *)) ind, Declareops.no_side_effects)
...
let rew_r2l_dep_scheme_kind =
  ...
  (fun ind -> build_r2l_rew_scheme true (Global.env()) ind InType,Declareops.no_side_effects)
...
let rew_r2l_forward_dep_scheme_kind =
  ...
  (fun ind -> build_r2l_forward_rew_scheme true (Global.env()) ind InType,Declareops.no_side_effects)
...
let rew_l2r_forward_dep_scheme_kind =
  ...
  (fun ind -> build_l2r_forward_rew_scheme true (Global.env()) ind InType,Declareops.no_side_effects)
...
let rew_l2r_scheme_kind =
  ...
  (fun ind -> fix_r2l_forward_rew_scheme
     (build_r2l_forward_rew_scheme false (Global.env()) ind InType), Declareops.no_side_effects)
...
let rew_r2l_scheme_kind =
  ...
  (fun ind -> build_r2l_rew_scheme false (Global.env()) ind InType, Declareops.no_side_effects)
...
let congr_scheme_kind = declare_individual_scheme_object "_congr"
  (fun ind ->
    (* May fail if equality is not defined *)
          build_congr (Global.env()) (get_coq_eq ()) ind, Declareops.no_side_effects)
