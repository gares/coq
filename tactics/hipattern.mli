...
val find_eq_data_decompose : ([ `NF ], 'r) Proofview.Goal.t -> constr ->
      coq_eq_data * Sorts.sort_instance * (types * constr * constr)
...
val find_eq_data : constr -> coq_eq_data * Sorts.sort_instance * equation_kind

(** Match a term of the form [(existT A P t p)] 
   Returns associated lemmas and [A,P,t,p] *)
val find_sigma_data_decompose : constr ->
  coq_sigma_data * (Sorts.sort_instance * constr * constr * constr * constr)
