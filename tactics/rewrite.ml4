    ...
    bind_gl_info
	 ...
	 in
	   try 
	     ...
	     in return (res, is_hyp) Declarations.no_side_effects
	   with
	   | Loc.Exc_located (_, TypeClassError (env, (UnsatisfiableConstraints _ as e)))
	   | TypeClassError (env, (UnsatisfiableConstraints _ as e)) ->
...
let anew_instance global binders instance fields =
  new_instance binders instance (Some (CRecord (Loc.ghost,None,fields)))
    ~global:(not (Locality.use_section_locality None)) ~generalize:false None
...
let declare_relation ?(binders=[]) a aeq n refl symm trans =
  init_setoid ();
  let global = not (Locality.use_section_locality None) in
...
let declare_projection n instance_id r =
  ...
  let cst =
    { const_entry_body = Future.from_val (term,Declarations.no_side_effects);
...
VERNAC COMMAND EXTEND AddSetoid1
   [ "Add" "Setoid" constr(a) constr(aeq) constr(t) "as" ident(n) ] ->
     [ add_setoid (not (Locality.use_section_locality None)) [] a aeq t n ]
  | [ "Add" "Parametric" "Setoid" binders(binders) ":" constr(a) constr(aeq) constr(t) "as" ident(n) ] ->
     [	add_setoid (not (Locality.use_section_locality None)) binders a aeq t n ]
  | [ "Add" "Morphism" constr(m) ":" ident(n) ] ->
      [ add_morphism_infer (not (Locality.use_section_locality None)) m n ]
  | [ "Add" "Morphism" constr(m) "with" "signature" lconstr(s) "as" ident(n) ] ->
      [ add_morphism (not (Locality.use_section_locality None)) [] m s n ]
  | [ "Add" "Parametric" "Morphism" binders(binders) ":" constr(m)
	"with" "signature" lconstr(s) "as" ident(n) ] ->
      [ add_morphism (not (Locality.use_section_locality None)) binders m s n ]
END
