...
let optimize_non_type_induction_scheme kind dep sort ind =
  if check_scheme kind ind then
    ...
    build_induction_scheme (Global.env()) Evd.empty ind dep sort, Declareops.no_side_effects
...
let rect_scheme_kind_from_type =
  declare_individual_scheme_object "_rect_nodep"
    (fun x -> build_induction_scheme_in_type false InType x, Declareops.no_side_effects)
...
let rect_dep_scheme_kind_from_type =
  declare_individual_scheme_object "_rect" ~aux:"_rect_from_type"
    (fun x -> build_induction_scheme_in_type true InType x, Declareops.no_side_effects)
...
let case_scheme_kind_from_type =
  ...
  (fun x -> build_case_analysis_scheme_in_type false InType x, Declareops.no_side_effects)
...
let case_dep_scheme_kind_from_type =
  ...
  (fun x -> build_case_analysis_scheme_in_type true InType x, Declareops.no_side_effects)

let case_dep_scheme_kind_from_type_in_prop =
  declare_individual_scheme_object "_casep_dep"
  (fun x -> build_case_analysis_scheme_in_type true InProp x, Declareops.no_side_effects)
