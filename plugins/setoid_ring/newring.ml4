...
let dummy_goal env =
  ...
  {Evd.it = gl; Evd.eff=Declareops.no_side_effects;
   Evd.sigma = sigma}
...
let add_theory name rth eqth morphth cst_tac (pre,post) power sign div =
  ...
  let lemma1 =
    decl_constant (Id.to_string name^"_ring_lemma1") (Future.from_val ( lemma1,Declareops.no_side_effects)) in
  let lemma2 =
    decl_constant (Id.to_string name^"_ring_lemma2") (Future.from_val ( lemma2,Declareops.no_side_effects)) in
  let cst_tac =
...
let add_field_theory name fth eqth morphth cst_tac inj (pre,post) power sign odiv =
  ...
  let lemma1 = decl_constant (Id.to_string name^"_field_lemma1") (Future.from_val (lemma1,Declareops.no_side_effects)) in
  let lemma2 = decl_constant (Id.to_string name^"_field_lemma2") (Future.from_val (lemma2,Declareops.no_side_effects)) in
  let lemma3 = decl_constant (Id.to_string name^"_field_lemma3") (Future.from_val (lemma3,Declareops.no_side_effects)) in
  let lemma4 = decl_constant (Id.to_string name^"_field_lemma4") (Future.from_val (lemma4,Declareops.no_side_effects)) in
  let cond_lemma = decl_constant (Id.to_string name^"_lemma5") (Future.from_val (cond_lemma,Declareops.no_side_effects)) in
  let cst_tac =
    interp_cst_tac env sigma morphth kind (zero,one,add,mul,opp) cst_tac in
  let pretac =
    match pre with
