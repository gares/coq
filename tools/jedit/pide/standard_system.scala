...
object Standard_System
{
  ...
  def getenv(name: String): String =
    try java.lang.System.getenv(name) catch { case e => ""}
  ...
  class Managed_Process(redirect: Boolean, env: Map[String, String], args: String*)
  {
    private val proc = raw_execute(null, env, redirect, (args):_*)
    ...
    {
      raw_execute(null, null, true, "kill", "-" + signal, "-" + pid).waitFor
      raw_execute(null, null, true, "kill", "-0", "-" + pid).waitFor == 0
    }
